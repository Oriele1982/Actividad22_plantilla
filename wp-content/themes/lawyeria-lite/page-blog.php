			...
			<div class="wrapper cf">
				<div id="posts">
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
						...
						<div class="post-meta">
							<span>
								<?php echo get_the_date(); ?> - <?php _e('In category:','lawyeria-lite'); ?> <?php the_category(', '); ?>
							</span><!--/span-->
						</div><!--/div .post-meta-->
						<?php
							if ( $feat_image != NULL ) { ?>
								<div class="post-image">
									<a href="<?php the_permalink(); ?>">
										<img src="<?php echo $feat_image[0]; ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" /></a>
								</div><!--/.post-image-->
							<?php } ?>
						<div class="post-excerpt">
							<?php the_excerpt(); ?>
						</div><!--/div .post-excerpt-->
						<a href="<?php the_permalink(); ?>" title="<?php _e( 'Read More', 'lawyeria-lite' ); ?>" class="read-more boton-rojo">
